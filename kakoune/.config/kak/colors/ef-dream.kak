...
declare-option str ssel 'rgb:544a50'
declare-option str psel 'rgb:412f4f'
...
set-face global keyword 'rgb:deb07a+b'
...
set-face global LineNumberCursor "%opt{cursor},%opt{bg_main}"
