...
local p, hl = require('config.statusline.provider'), api.nvim_set_hl
...
--- make a statusline to be rendered
---@param comps table
---@return table comps returned back
---@return table events the events for which the statusline will update
---@return table pieces
local function make_statusline(comps)
    local e, pieces = {}, {}
    iter(ipairs(comps))
...
---renders the statusline made with make_statusline
---@param comps table
---@param events table
---@param pieces table
---@return thread
...
-- setup()
local comps, events, pieces = make_statusline(default)
